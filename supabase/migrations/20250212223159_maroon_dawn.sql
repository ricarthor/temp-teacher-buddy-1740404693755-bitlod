/*
  ...
  1. Tables
    - `courses`
      - Primary table for managing courses
      - Contains course details and user ownership
    - `students`
      - Student information with course relationship
    - `course_students`
      - Junction table for course-student relationships
    - `quizzes`
      - Quiz information with course relationship
    - `questions`
      - Quiz questions
    - `submissions`
      - Quiz submissions from students
    - `feedback`
      - Student feedback for quizzes
    - `flags`
      - Student flags/alerts
